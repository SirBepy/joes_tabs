...
**Source:** DesignImages/Trending 5.png

## Purpose
The Trending screen: a scrollable list of currently popular ukulele/guitar tabs the user can browse, filter, save, and open. This is the second of two color/typography variants of the same screen (see trending-2.md).
...
- Relationship to variant 2: same layout, same content, same saved/unsaved states. The only difference is row text color. In this variant, song TITLES are dark / near-black and artist names are orange. (In trending-2 the titles are orange and the artists are gray.) Pick one as the production style.
